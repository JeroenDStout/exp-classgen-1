...
function(classgen_proc_single source destination append_generated_inc)
  ...
  set(loc_gen_inc ${${append_generated_inc}})
  list(APPEND loc_gen_inc "${destination}/${base_out_name}.h")
  # 
  ...
  set(${append_generated_inc} ${loc_gen_inc} PARENT_SCOPE)
endfunction()
